...
ENT.Lights = {
	{
		...
		Sprites = {
			...
			{ pos = "bulb4a", colorR = 255, colorG = 255, colorA = 255, width = 20, height = 20 },
		},
	},
	{
		Siren = true,
	...
	},
	{
		Trigger = "high",
		ProjectedTextures = {
			{ pos = Vector(68,-20.77,23.67), ang = Angle(0,0,0), colorB = 200, colorA = 150, shadows = true, bodygroup = { name = "front", active = { 0 } }, },
			{ pos = Vector(68,20.77,23.67), ang = Angle(0,0,0), colorB = 200, colorA = 150, shadows = true, bodygroup = { name = "front", active = { 0 } }, },
		},
	},
