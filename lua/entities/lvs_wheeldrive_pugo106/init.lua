...
function ENT:OnSpawn( PObj )
	...
	local Engine = self:AddEngine( Vector(50,0,27) )
	...
	local FuelTank = self:AddFuelTank( Vector(-50,0,20), Angle(0,0,0), 5000, LVS.FUELTYPE_PETROL )
	FuelTank:SetDoorHandler( FuelCap )

	local WheelModel = "models/diggercars/peugeot_106/106_wheel.mdl"
