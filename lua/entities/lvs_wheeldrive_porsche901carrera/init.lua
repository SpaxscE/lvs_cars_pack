...
function ENT:OnSpawn( PObj )
	...
	self:AddFuelTank( Vector(-50,0,15), Angle(0,0,0), 2600, LVS.FUELTYPE_PETROL )
	...
	local WheelModel = "models/diggercars/porsche_901/fw.mdl"
	local WheelModelR = "models/diggercars/porsche_901/rw.mdl"
